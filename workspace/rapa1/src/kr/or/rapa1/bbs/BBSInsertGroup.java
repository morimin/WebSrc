 ...
 */
@WebServlet("/BBSInsertGroup")
public class BBSInsertGroup extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = String.format("insert into bbsgroup (title, odr, useflag) values('%s','%s','%s')", title, odr, useflag);			
