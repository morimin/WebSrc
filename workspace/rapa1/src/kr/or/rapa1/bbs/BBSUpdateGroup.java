 ...
 */
@WebServlet("/BBSUpdateGroup")
public class BBSUpdateGroup extends HttpServlet {	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql = String.format("update bbsgroup set title='%s', useflag='%s', odr='%s' where gidx='%s' ", title, useflag, odr, gidx);			
			...
			{  // 1보다 작으면 error
				...
				request.setAttribute("nextURL", "main.jsp?CMD=manBBS.jsp?sub=1");
